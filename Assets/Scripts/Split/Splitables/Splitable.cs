...
namespace MeshSplitting.Splitables
{
    ...
    public class Splitable : MonoBehaviour, ISplitable
    {
        ...
        private void CreateNewObjects()
        {
            ...
            GameObject objectNew = Instantiate(gameObject, transform.position, transform.rotation);
            ...
            objectNew.GetComponent<Splitable>().UseCapUV = true;
            objectNew.GetComponent<Splitable>().object0 = newGOs[0];
            newGOs[0].GetComponent<MeshRenderer>().enabled = false;
            objectNew.GetComponent<Splitable>().object1 = newGOs[1];
            newGOs[1].GetComponent<MeshRenderer>().enabled = true;
            objectNew.GetComponent<MeshRenderer>().enabled = false;
            Destroy(newGOs[0].GetComponent<Splitable>());
            Destroy(newGOs[1].GetComponent<Splitable>());
            Camera.main.GetComponent<ControllerMap>().AddGameObject(newGOs[0]);
            Camera.main.GetComponent<ControllerMap>().AddGameObject(newGOs[1]);
        }
